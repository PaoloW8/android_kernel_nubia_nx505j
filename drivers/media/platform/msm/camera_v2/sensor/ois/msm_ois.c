...
void RamReadA(unsigned short ram_addr, void *read_data_16)
{
	 ...
	 msm_ois_t.i2c_client.addr_type = MSM_CAMERA_I2C_WORD_ADDR;
	 msm_ois_t.i2c_data_type = MSM_OIS_WORD_DATA;
	 rc =  msm_ois_t.i2c_client.i2c_func_tbl->i2c_read
	 (
		&msm_ois_t.i2c_client,
...
void RamRead32A(unsigned short ram_addr, void *read_data_32)
{
	 ...
	 msm_ois_t.i2c_client.addr_type = MSM_CAMERA_I2C_WORD_ADDR;
	 msm_ois_t.i2c_data_type = MSM_OIS_BYTE_DATA;
	 rc =  msm_ois_t.i2c_client.i2c_func_tbl->i2c_read_seq
	 (
		&msm_ois_t.i2c_client,
		ram_addr, &data[0],
		4);
...
void RamWrite32A(unsigned short ram_addr, unsigned long write_data_32)
{
	 ...
	 msm_ois_t.i2c_client.addr_type = MSM_CAMERA_I2C_WORD_ADDR;
	 msm_ois_t.i2c_data_type = MSM_OIS_BYTE_DATA;
	 rc =  msm_ois_t.i2c_client.i2c_func_tbl->i2c_write_seq
	 (
		&msm_ois_t.i2c_client,
		ram_addr, &data[0],
		4);
...
EXPORT_SYMBOL(RegReadA);
EXPORT_SYMBOL(RegWriteA);
EXPORT_SYMBOL(RamReadA);
EXPORT_SYMBOL(RamWriteA);
EXPORT_SYMBOL(RamRead32A);
EXPORT_SYMBOL(RamWrite32A);

void msm_ois_init_cci(void)
{
       int rc;
	rc = msm_ois_t.i2c_client.i2c_func_tbl->i2c_util(
		&msm_ois_t.i2c_client, MSM_CCI_INIT);
...
void msm_ois_release_cci(void)
{
       int rc;
	rc = msm_ois_t.i2c_client.i2c_func_tbl->i2c_util(
		&msm_ois_t.i2c_client, MSM_CCI_RELEASE);
...
static int32_t msm_ois_i2c_init(void)
{
	int32_t rc = 0;
	struct msm_camera_cci_client *cci_client = NULL;
	CDBG("Enter\n");

       msm_ois_t.cci_master = 0;
	msm_ois_t.cam_name = 0;
	...
	msm_ois_t.i2c_client.cci_client->sid = 0x24;
	msm_ois_t.i2c_client.cci_client->retries = 3;
	msm_ois_t.i2c_client.cci_client->id_map = 0;
	msm_ois_t.i2c_client.cci_client->cci_i2c_master = 0;
