...
static struct gpiomux_setting sd_card_det_active_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP, /* ZTEMT: pull up SD_CARD_DET */
	.dir = GPIOMUX_IN,
};
...
//Add by wuzehui
static struct gpiomux_setting speaker_amp_active= {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config speaker_ext_gpio_configs[] __initdata = {
    {
		...
		.settings = {
			[GPIOMUX_ACTIVE]    = &speaker_amp_active,
			[GPIOMUX_SUSPENDED] = &speaker_amp_sleep,
		},
    },
};
// end by wuzehui
...
#if defined(CONFIG_ZTE_CAMERA_NX507J)
	{
		.gpio = 66, /* CAM2_RST_N */
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[3],
