...
static struct clk_lookup msm_clocks_8974pro_only[] __initdata = {
	...
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "20.qcom,camera"),
		...
		CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "34.qcom,eeprom"),
       #endif
	#ifdef CONFIG_IMX214_OIS_SHARP
		CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "22.qcom,camera"),
              CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "22.qcom,eeprom"),
       #endif

	#ifdef CONFIG_OV5648_Z7MINI
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "71.qcom,camera"),
       #endif
	...
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "20.qcom,camera"),
		...
		CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "34.qcom,eeprom"),
       #endif
	
	#ifdef CONFIG_IMX214_OIS_SHARP
		CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "22.qcom,camera"),
		CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "22.qcom,eeprom"),
       #endif

	#ifdef CONFIG_OV5648_Z7MINI
	CLK_LOOKUP("cam_clk", camss_mclk2_clk.c, "71.qcom,camera"),
       #endif
