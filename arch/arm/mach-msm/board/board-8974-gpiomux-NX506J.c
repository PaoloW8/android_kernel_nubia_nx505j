...
/* ZTEMT Added by LiuYongfeng, 2013/12/2 */
#ifdef CONFIG_SERIAL_MSM_HSL
	{
		.gpio	   = 0, 	/* BLSP1 QUP UART TX */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
	{
		.gpio	   = 1, 	/* BLSP1 QUP UART RX */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
...
static struct gpiomux_setting tfa9890_reset_act = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting tfa9890_reset_sus = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting tfa9890_int= {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_IN,
};
static struct msm_gpiomux_config tfa9890_gpio_config[] __initdata = {
	{
		.gpio      = 56,		/* tfa9890_reset */
		.settings = {
			[GPIOMUX_ACTIVE] = &tfa9890_reset_act,
			[GPIOMUX_SUSPENDED] = &tfa9890_reset_sus,
		},
	},
	{
		.gpio      = 55,		/*tfa9890_intr*/ 
		.settings = {
			[GPIOMUX_SUSPENDED] = &tfa9890_int,
		},
	},
...
static struct msm_gpiomux_config msm_sensor_configs[] __initdata = {
	...
	#if defined(CONFIG_ZTE_CAMERA_NX506J)
	{
		.gpio = 66, /* CAM2_RST_N */
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[3],
	...
	{
		.gpio = 69, /* back camera DVDD GPIO CONTROL */
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[3],
			[GPIOMUX_SUSPENDED] = &gpio_suspend_config[1],
		},
...
#ifdef CONFIG_SND_SOC_TFA9890
    msm_gpiomux_install(tfa9890_gpio_config,ARRAY_SIZE(tfa9890_gpio_config));
#endif
